...
export -f qa_query
export -f _qa_sanitize_index
export -f _qa_sanitize_input
export -f qq
export -f a
export -f echo64
export -f fa
export -f q_gpt_query
export -f qa_help
export -f qa_status
export -f qa_set_apikey
export -f qa_set_engine
export -f qa_set_context
export -f qa_select_engine
export -f q-init
export -f q
export -f qa_delete
export -f qa_responses
export -f _truncate_middle
export -f qa_test
export -f _get_openai_api
export -f _get_qa_engine
export -f _get_qa_context
