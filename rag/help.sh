...
Options:
  -i FILE_OR_DIR     Directly include one or more files or directories.
                     Can be used multiple times or provide multiple items.
...
Description:
  ...
  Exclusion patterns from .gitignore and .multignore files found in the current
  directory downwards are loaded automatically, and can be added via -x.
